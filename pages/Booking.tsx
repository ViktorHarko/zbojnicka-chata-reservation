...
function getNights(from: Date, to: Date) {
  ...
  const diff = Math.round((t.getTime() - f.getTime()) / MS_PER_DAY);
...
const SearchStep = ({ booking, setBooking, onSelectRoom }: { booking: BookingState, setBooking: React.Dispatch<React.SetStateAction<BookingState>>, onSelectRoom: (r: Room) => void }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row flex-grow min-h-[600px]">
      ...
      <div className="bg-primary text-white w-full md:w-1/3 p-8 flex flex-col">
      ...
      <div className="bg-beige w-full md:w-2/3 p-8 md:p-16">
    ...
    <div className="container mx-auto px-6 py-8">
      ...
      <div className="grid md:grid-cols-12 gap-8">
         ...
         <div className="md:col-span-9 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 bg-surface p-8 rounded-xl border-4 border-primary shadow-sm relative">
