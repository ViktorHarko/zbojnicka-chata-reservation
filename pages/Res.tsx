        ...
        <section className="bg-primary text-white">
          <div className="grid md:grid-cols-2 min-h-[450px]">
            ...
            <div className="p-8 md:p-16 flex flex-col justify-center">
              <h1 className="text-3xl md:text-4xl font-bold uppercase mb-6 leading-snug tracking-wide" dangerouslySetInnerHTML={{__html: t('year_round_stay')}}>
              </h1>
              <div className="w-24 h-1 bg-accent mb-8"></div>
              <p className="text-gray-200 mb-4 leading-relaxed max-w-lg text-sm md:text-base">
                {t('evening_view')}
              </p>
              <p className="text-gray-200 leading-relaxed max-w-lg text-sm md:text-base">
                {t('magical_morning')}
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col justify-center">
                <h2 className="text-3xl md:text-4xl font-bold uppercase text-black mb-6">
                  {t('online_booking')}
                </h2>
              ...
              <div className="relative h-[350px] w-full flex items-center justify-center md:justify-end pr-0 md:pr-10">
                <div className="relative w-[320px] h-[300px] md:w-[400px]">
                    ...
                    <div className="absolute top-1/2 left-0 md:left-4 transform -translate-y-1/2 w-48 h-48 md:w-60 md:h-60 rounded-full overflow-hidden border-4 border-white shadow-2xl z-10">
                        <img src="https://picsum.photos/id/1015/400/400" className="w-full h-full object-cover" alt="Hikers" />
                    </div>
                    ...
                    <div className="absolute top-1/2 right-0 md:right-4 transform -translate-y-1/2 w-48 h-48 md:w-60 md:h-60 rounded-full overflow-hidden border-4 border-white shadow-2xl z-20">
                         <img src="https://picsum.photos/id/1016/400/400" className="w-full h-full object-cover" alt="Snow" />
                    </div>
                </div>
              </div>
            </div>
